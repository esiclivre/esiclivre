...
) ENGINE=InnoDB COMMENT='anexos da lei de acesso' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB COMMENT='escolaridades do sistema de lei de acesso' AUTO_INCREMENT=7 ;
...
) ENGINE=InnoDB COMMENT='faixa etaria do sistema de lei de acesso' AUTO_INCREMENT=5 ;
...
CREATE TABLE IF NOT EXISTS `lda_movimentacao` (
  ...
  KEY `idsolicitacao` (`idsolicitacao`)
) ENGINE=InnoDB COMMENT='movimentação das solicitações do lei de acesso' AUTO_INCREMENT=1;
...
) ENGINE=InnoDB COMMENT='solicitações do lei de acesso';
...
) ENGINE=InnoDB  COMMENT='Tipos de solicitação da solicitação de informação' AUTO_INCREMENT=6 ;
...
) ENGINE=InnoDB  COMMENT='escolaridades do sistema de lei de acesso' AUTO_INCREMENT=4 ;
...
CREATE TABLE IF NOT EXISTS `sis_acao` (
  ...
  PRIMARY KEY (`idacao`),
  KEY `idtela` (`idtela`)
) ENGINE=InnoDB  AUTO_INCREMENT=529 ;
...
) ENGINE=InnoDB COMMENT='registro de tentativas de login de usuario';
...
) ENGINE=InnoDB  AUTO_INCREMENT=1182 ;
...
CREATE TABLE IF NOT EXISTS `sis_permissao` (
  ...
  KEY `idacao` (`idacao`),
  KEY `idgrupo` (`idgrupo`)
) ENGINE=InnoDB  AUTO_INCREMENT=56561 ;
...
CREATE TABLE IF NOT EXISTS `sis_usuario` (
  ...
  KEY `idusuarioinclusao` (`idusuarioinclusao`),
  KEY `idusuarioalteracao` (`idusuarioalteracao`)
) ENGINE=InnoDB  PACK_KEYS=0 AUTO_INCREMENT=17 ;
...
CREATE TABLE IF NOT EXISTS `lda_enquete` (
  ...
  KEY `idsolicitante` (`idsolicitante`)
) ENGINE=InnoDB  COMMENT='Enquete do feedback do solicitante sobre o sistema' AUTO_INCREMENT=1 ;
-- ----------------------------------
