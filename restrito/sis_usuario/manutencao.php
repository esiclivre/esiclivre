...
***********************************************************************************/
  ...
  $gruposselecionados = null;
    ...
    $gruposselecionados = isset($_POST['gruposselecionados']) ? $_POST['gruposselecionados'] : array();
    $sicselecionados = isset($_POST['sicselecionados']) ? $_POST['sicselecionados'] : array();
