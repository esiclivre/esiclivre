...
if (isset($_REQUEST['acao'])) {
  ...
  ? filter_var($_REQUEST["nome"])
  : null;

  $login = isset($_REQUEST["login"])
  ? filter_var($_REQUEST["login"])
  : null;

  $matricula = isset($_REQUEST["matricula"])
  ? filter_var($_REQUEST["matricula"])
  : null;

  $cpfusuario = isset($_REQUEST["cpfusuario"])
  ? filter_var($_REQUEST["cpfusuario"])
  : null;

  $idsecretaria = isset($_REQUEST["idsecretaria"])
  ? filter_var($_REQUEST["idsecretaria"])
  : null;

  $status = isset($_REQUEST["status"])
  ? filter_var($_REQUEST["status"])
  : null;
