...
***********************************************************************************/
  ...
  $idtiposolicitacao_seguinte = filter_input(INPUT_POST, 'idtiposolicitacao_seguinte');
  if ($idtiposolicitacao_seguinte == -1) {
    $idtiposolicitacao_seguinte = '';
  }
  ...
  if (isset($_POST['acao'])) {
	...
	} elseif(isset($_POST['idtiposolicitacao_seguinte'])) {
