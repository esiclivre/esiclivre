...
$token2 = isset($_REQUEST["to2"]) ? $_REQUEST["to2"] : null;
$notRedir = isset($_REQUEST["red"]) ? $_REQUEST["red"] : null;
$msg = "";

//usado pra troca de sic, chamado no arquivo topo através do select de sics
$sic = filter_input(INPUT_GET, 'sic');
if(!empty($sic))
...
if (isset($_POST['btsub'])) {
    if ($usarecap) {
        ...
        $recaptcha_ok = (strtoupper($palavra) == strtoupper($_SESSION["palavra"]));
    } else
        $recaptcha_ok = true;
