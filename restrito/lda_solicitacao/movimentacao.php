...
<script>
    function fechaTudo(){
        ...
        <?php if(checkPerm("LDAPRORROGAR",false)  //tiver permissao de prorrogar
                 and $situacao != "N" and $situacao != "R"    //situa��o for "finalizado"
...
<div class="container-fluid">
    <table align="center" cellpadding="0" width="100%" cellspacing="1" class="tabDetalhe table">
        ...
        <?php
            ...
            <tr>
                <th align="left" colspan="4" onclick="abreFechaMovimentacoes()">MOVIMENTAÇÕES</th>
            </tr>
                ...
                <td align="left" colspan="4">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea name="despacho" rows="10" cols="100" onkeyup="setMaxLength(4000,this);"><?php echo $despacho;?></textarea>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr id="lnProrrogar2" style="display: none">
                ...
                <td colspan="3" align="left">
                    <textarea name="txtmotivoprorrogacao" rows="4" cols="60" onkeyup="setMaxLength(2000,this);"><?php echo $txtmotivoprorrogacao;?></textarea>
                </td>
            </tr>
            <tr>
                <td colspan="4">
                    ...
                    <?php
                        ...
                        if(checkPerm("LDARESPONDER",false)  //tiver permissao de responder a demanda
                           and $situacao != "N" and $situacao != "R"//situa��o nao for finalizada ([N]egado ou [R]espondido)
                            )
                        {
                            ?>
