...
$numprotocolo = isset($_REQUEST["fltnumprotocolo"])
? $_REQUEST["fltnumprotocolo"]
: null;

$solicitante = isset($_REQUEST["fltsolicitante"])
? $_REQUEST["fltsolicitante"]
: null;

$situacao = isset($_REQUEST["fltsituacao"])
? $_REQUEST["fltsituacao"]
: null;

$idSicUsuario	= getSession('idsecretaria');

// parametros a ser passado para a pagina de detalhamento, fazendo com que ao
// voltar para o index traga as informações passadas anteriormente
$parametrosIndex = "fltnumprotocolo=$numprotocolo&fltsolicitante=$solicitante&fltsituacao=$situacao";
...
//seleciona as solicitações não respondidas e sua ultima movimenta��o (recupera variaveis de configuracao de prazos)
/*
...
<section>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control icon awesomplete" name="fltnumprotocolo" value="<?php echo $numprotocolo; ?>" maxlength="50" size="30" placeholder="Nº do protocolo"  data-list="<?php while ($registro = mysqli_fetch_array($rs2)) { ?><?=$registro["numprotocolo"] . '/' . $registro["anoprotocolo"] . ', ';?><?php } ?>" />
                        </div>
                    </div>
                    <div class="col-md-2 col-xs-12">
                        <div class="form-group">
    ...
    while ($registro = mysqli_fetch_array($rs)) {
            ...
            $confirmacao="";
            //se existir movimenta��o que não tenha sido recebida e o usuario for da secretaria de recebimento, ou a solicitita��o não tenha sido recebida nenhuma vez e o usu�rio tiver visibilidade de SIC central
