...
$updt = filter_input(INPUT_GET, 'updt');

if ($idgrupo and !$updt) {
	include "../inc/topo.php";
  $nomegrupo = filter_input(INPUT_GET, 'nomegrupo');
...
<div class="container-fluid">
	<!--form name="permissoes" method="post" action="<?php echo $_SERVER['PHP_SELF']."?idgrupo=$idgrupo&grupo=$nomegrupo";?>" id="form1"-->
	<form name="permissoes" method="post" action="<?php echo $_SERVER['PHP_SELF']."?sis_grupo&p=grupoperm&idgrupo=$idgrupo&grupo=$nomegrupo";?>" id="form1">
	<table cellspacing="0">
	<?php
	$menu = "";
	$tela = "";
