...
<div class="container-fluid">
	                ...
	                <table border="0" width="100%">
	                    <tr>
	                        <td valign="top" align="center">
	                            ...
	                            <select name="usuarios" id="usuarios" title="Dá um duplo clique para selecionar todos" ondblclick="selecionatudo(this.id);" multiple="multiple" style="height: 300px; width: 300px; font-size:10">
	                                <?php
	...
	?>
	                        ...
	                        <td valign="top" align="center">
	                            ...
	                            <select name="selecionados[]" id="selecionados" title="Dá um duplo clique para selecionar todos" ondblclick="selecionatudo(this.id);" multiple="multiple" style="height: 300px; width: 300px; font-size:10">
	                                <?php
