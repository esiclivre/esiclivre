...
$siglaSicUsuario = isset($_SESSION["sgsecretaria"])
? isset($_SESSION["sgsecretaria"])
: null;

$origem = isset($_REQUEST["fltorigem"])
? $_REQUEST["fltorigem"]
: null;

$sicDestino = isset($_REQUEST["fltsecdestino"])
? $_REQUEST["fltsecdestino"]
: null;

$month = isset($_REQUEST["fltmonth"])
? $_REQUEST["fltmonth"]
: null;

$abeRes = isset($_REQUEST["fltAbeRes"])
? $_REQUEST["fltAbeRes"]
: null;

// parametros a ser passado para a pagina de detalhamento,
// fazendo com que ao voltar para o index traga as informaçõees
// passadas anteriormente
$parametrosIndex = "
  fltnumprotocolo=$numprotocolo
  &fltsolicitante=$solicitante
  &fltsituacao=$situacao
  &fltorigem=$origem
";
